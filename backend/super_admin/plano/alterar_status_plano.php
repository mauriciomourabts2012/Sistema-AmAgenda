...
try {
    ...
    auditoriaRegistrar($conexao, 'plano.status_alterado', [
        'ator'=>auditoriaResolverAtorSuperAdmin($conexao),'entidade_id'=>(int)$idPlano,'entidade_rotulo'=>$nomePlano,
        'descricao'=>'Alterou o status do plano ' . $nomePlano . '.',
